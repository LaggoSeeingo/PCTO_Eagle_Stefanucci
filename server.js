...
const dataFolderPath = '/root/progetto1/dati';
...
const idFilePath = path.join(dataFolderPath, 'currentId.txt');

// Carica l'ID corrente dal file, se esiste
if (fs.existsSync(idFilePath)) {
    currentId = parseInt(fs.readFileSync(idFilePath, 'utf8'), 10);
}
